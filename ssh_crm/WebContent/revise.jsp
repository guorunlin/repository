...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/UserAction_toEdit"  method=post>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <INPUT id=txtName 
                  style="WIDTH: 130px" name="user_code" value="<s:property value="#user.user_code" />">
                  </TD>
               </TR>
              <TR>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px"><INPUT id=txtcode 
                  style="WIDTH: 130px" name="user_name" value="<s:property value="#user.user_name" />" ></TD>
