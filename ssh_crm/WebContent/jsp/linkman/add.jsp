						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
									...
									maxLength=50 name="lkm_name" value="<s:property value="#linkMan.lkm_name" />">
								</td>
								<td>联系人性别：</td>
								<td>
							...
							<TR>
								...
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									 maxLength=50 name="lkm_phone" value="<s:property value="#linkMan.lkm_phone" />">
								</td>
								<td>联系人手机 ：</td>
								<td>
									<INPUT class=textbox id=sChannel2style="WIDTH: 180px" 
									maxLength=50 name="lkm_mobile" value="<s:property value="#linkMan.lkm_mobile" />">
								</td>
							</TR>
							<tr>
								<td rowspan=2>
